...
class ConditionalUnet1D(nn.Module):
    ...
    def forward(self,
        ...
        Treats input_dim as the channel dimension for 1D convolution. (convolution responses added across channel dimension)
        """
        # (B,T,C)
...
if __name__ == '__main__':
    ...
    # # Dummy input
    noise = torch.randn(64, 1, 128) # (B,T, input_dim)
    cond = torch.randn(64, 1) # (B, global_cond_dim)
    out = model(sample = noise, timestep=0, global_cond=cond)
     
    print(out.shape) # (B,T,input_dim)